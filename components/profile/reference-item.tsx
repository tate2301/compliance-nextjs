    ...
    return (
        <li className="pl-3 pr-4 py-3 flex flex-wrap items-center justify-between text-sm">
            <div className="flex-1 flex items-center mb-2">
                <UserIcon className="flex-shrink-0 h-5 w-5 text-sand-11" aria-hidden="true" />
                <div>
                    <p className="ml-2 flex-1">{fullname}</p>
                    <p className="ml-2 flex-1 text-sand-10">{email_address}</p>
                </div>
            </div>
            <div className="ml-4 flex-shrink-0 flex space-x-4">
                ...
                <span className="text-sand-8" aria-hidden="true">|</span>
                <Button
                    variant="ghost"
