...
import { ChevronDownIcon, OfficeBuildingIcon, QuestionMarkCircleIcon } from '@heroicons/react/solid';
            ...
            <div className='mb-4'>
                <Breadcrumb>
                    <BreadcrumbList>
                        ...
                        <BreadcrumbItem>
                            <BreadcrumbLink asChild>
                                <Link href="#"><OfficeBuildingIcon className='size-4 inline-flex mr-1' />Shifts</Link>
                            </BreadcrumbLink>
                        </BreadcrumbItem>
                    </BreadcrumbList>
                </Breadcrumb>
            ...
            <div className='flex gap-8 items-start mb-4'>
                <div className='flex-1'>
                    ...
                    <p className='text-sm text-slate-11'>
                        RMN required <QuestionMarkCircleIcon className='size-4 ml-1 inline-flex self-center' />
                    </p>
                </div>
                <div>
                    <p className='mb-1'>
