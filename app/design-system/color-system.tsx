        ...
        <div className={`space-y-12 ${theme === 'dark' ? 'dark' : ''}`}>
            <div className="flex justify-between items-center">
                <div className="space-y-4">
                    <h1 className="text-3xl font-bold text-slate-12">Mercury Design System Color System</h1>
                ...
                <button
                    onClick={toggleTheme}
                    className="p-2 rounded-full bg-slate-3 hover:bg-slate-4 transition-colors"
                    aria-label={`Switch to ${theme === 'light' ? 'dark' : 'light'} mode`}
                >
                    {theme === 'light' ? (
                        <Moon className="w-5 h-5 text-slate-11" />
                    ) : (
                        <Sun className="w-5 h-5 text-slate-11" />
                    )}
                </button>
            </div>

            <div className="space-y-2">
                <h2 className="text-2xl font-semibold text-slate-12">Color Principles</h2>
                <ul className="list-disc pl-5 space-y-2 text-slate-11">
            ...
            <div className="space-y-2">
                <h2 className="text-2xl font-semibold text-slate-12">Naming Convention</h2>
                <p className="text-slate-11">
                    Our color variables follow the naming pattern: <code className="bg-slate-3 text-slate-12 px-1 py-0.5 rounded">color-scale</code>, for example <code className="bg-slate-3 text-slate-12 px-1 py-0.5 rounded">primary-9</code> or <code className="bg-slate-3 text-slate-12 px-1 py-0.5 rounded">slate-12</code>.
                </p>
            </div>
            ...
            <div className="space-y-8">
                {colorScales.map((scale) => (
                    <div key={scale.name} className="space-y-4">
                        <div>
                            <h2 className="text-2xl font-semibold text-slate-12 capitalize">{scale.name}</h2>
                            <p className="text-slate-11">{scale.description}</p>
                        </div>
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                            {scale.swatches.map((swatch) => (
                                <div
                                    ...
                                    className="border border-slate-6 rounded-lg p-4 bg-white"
                                >
                                    <div className="space-y-3">
                                        <div className="flex justify-between items-center">
                                            <code className="text-xs bg-slate-3 px-2 py-1 rounded">
            ...
            <div className="space-y-4 pt-8">
                <h2 className="text-2xl font-semibold text-slate-12">Gradient Color Variants</h2>
                <p className="text-slate-11">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 mt-4">
                    <div className="rounded-lg overflow-hidden shadow-sm">
                        ...
                        <div className="p-4 bg-white border border-slate-6 border-t-0 rounded-b-lg">
                            <h3 className="font-medium text-slate-12">Primary to Secondary</h3>
                            <p className="text-sm text-slate-11">Used for prominent UI elements</p>
                            <code className="mt-2 block text-xs bg-slate-3 p-2 rounded">bg-gradient-to-r from-primary-9 to-secondary-9</code>
                        </div>
                    </div>
                    ...
                    <div className="rounded-lg overflow-hidden shadow-sm">
                        ...
                        <div className="p-4 bg-white border border-slate-6 border-t-0 rounded-b-lg">
                            <h3 className="font-medium text-slate-12">Tri-tone Gradient</h3>
                            <p className="text-sm text-slate-11">Used for call-to-action elements</p>
                            <code className="mt-2 block text-xs bg-slate-3 p-2 rounded">bg-gradient-to-br from-secondary-8 via-primary-9 to-secondary-9</code>
                        </div>
                    </div>

                    <div className="rounded-lg overflow-hidden shadow-sm">
                        <div className="h-24 bg-gradient-to-t from-slate-1 to-primary-2"></div>
                        <div className="p-4 bg-white border border-slate-6 border-t-0 rounded-b-lg">
                            <h3 className="font-medium text-slate-12">Subtle Background</h3>
                            <p className="text-sm text-slate-11">Used for section backgrounds</p>
                            <code className="mt-2 block text-xs bg-slate-3 p-2 rounded">bg-gradient-to-t from-slate-1 to-primary-2</code>
                        </div>
                    </div>
                    ...
                    <div className="rounded-lg overflow-hidden shadow-sm">
                        ...
                        <div className="p-4 bg-white border border-slate-6 border-t-0 rounded-b-lg">
                            <h3 className="font-medium text-slate-12">Success Gradient</h3>
                            <p className="text-sm text-slate-11">Used for positive status indicators</p>
                            <code className="mt-2 block text-xs bg-slate-3 p-2 rounded">bg-gradient-to-r from-success-8 to-success-9</code>
                        </div>
                    </div>
                    ...
                    <div className="rounded-lg overflow-hidden shadow-sm">
                        ...
                        <div className="p-4 bg-white border border-slate-6 border-t-0 rounded-b-lg">
                            <h3 className="font-medium text-slate-12">Error Gradient</h3>
                            <p className="text-sm text-slate-11">Used for critical status indicators</p>
                            <code className="mt-2 block text-xs bg-slate-3 p-2 rounded">bg-gradient-to-r from-error-8 to-error-9</code>
                        </div>
                    </div>

                    <div className="rounded-lg overflow-hidden shadow-sm">
                        <div className="h-24 bg-gradient-to-br from-slate-12 to-slate-10"></div>
                        <div className="p-4 bg-white border border-slate-6 border-t-0 rounded-b-lg">
                            <h3 className="font-medium text-slate-12">Neutral Gradient</h3>
                            <p className="text-sm text-slate-11">Used for neutral or disabled states</p>
                            <code className="mt-2 block text-xs bg-slate-3 p-2 rounded">bg-gradient-to-br from-slate-12 to-slate-10</code>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div className="space-y-4 pt-6">
                <h3 className="text-xl font-medium text-slate-12">Gradient Usage Guidelines</h3>
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    <div className="space-y-3 bg-slate-1 p-4 rounded-lg">
                        <h4 className="font-medium text-slate-12">Best Practices</h4>
                        <ul className="list-disc pl-5 space-y-2 text-sm text-slate-11">
                    ...
                    <div className="space-y-3 bg-slate-1 p-4 rounded-lg">
                        <h4 className="font-medium text-slate-12">Component Applications</h4>
                        <ul className="list-disc pl-5 space-y-2 text-sm text-slate-11">
            ...
            <div className="space-y-4 pt-4">
                <h2 className="text-2xl font-semibold text-slate-12">Color Usage Guidelines</h2>

                <div className="space-y-4">
                    <div>
                        <h3 className="text-lg font-medium text-slate-12">Text Hierarchy</h3>
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-2">
                            <div className="p-4 bg-white rounded-md shadow-sm">
                                <p className="text-slate-12 font-semibold mb-1">High-contrast Text (slate-12)</p>
                                <p className="text-slate-11 mb-1">Medium-contrast Text (slate-11)</p>
                                <p className="text-slate-10">Low-contrast Text (slate-10)</p>
                            </div>
                            <div className="p-4 bg-slate-12 rounded-md shadow-sm">
                                <p className="text-white font-semibold mb-1">Light Text on Dark (white)</p>
                                <p className="text-slate-4 mb-1">Medium-contrast Text (slate-4)</p>
                                <p className="text-slate-6">Low-contrast Text (slate-6)</p>
                            </div>
                        </div>
                    </div>

                    <div>
                        <h3 className="text-lg font-medium text-slate-12">Interactive Elements</h3>
                        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mt-2">
                            ...
                            <button className="px-4 py-2 bg-slate-3 text-slate-12 rounded-md shadow-sm hover:bg-slate-4 transition-colors">
                                Tertiary Button
                            </button>
                        </div>
                    </div>
                    ...
                    <div>
                        <h3 className="text-lg font-medium text-slate-12">Status Colors</h3>
                        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mt-2">
            ...
            <div className="space-y-4 pt-4">
                <h2 className="text-2xl font-semibold text-slate-12">Accessibility</h2>
                <p className="text-slate-11">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-2">
                    <div className="p-4 bg-white rounded-md shadow-sm border border-slate-6">
                        <h4 className="font-medium text-slate-12 mb-2">Accessible Color Combinations</h4>
                        <div className="space-y-2">
                            ...
                            <div className="flex items-center">
                                <div className="w-16 h-8 bg-slate-12 rounded-l-md"></div>
                                <div className="w-16 h-8 bg-white rounded-r-md flex items-center justify-center text-sm font-medium">
                                    16:1
                                </div>
                            </div>
                    ...
                    <div className="p-4 bg-white rounded-md shadow-sm border border-slate-6">
                        <h4 className="font-medium text-slate-12 mb-2">Accessible Text</h4>
                        <div className="space-y-2">
                            <p className="text-slate-12 font-medium">Primary Text (Slate-12)</p>
