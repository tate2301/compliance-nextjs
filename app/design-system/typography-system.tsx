...
function TypographyExample({ variant, className, size, description, example }: TypographyExampleProps) {
    return (
...
export default function TypographySystem() {
    const typographyScale = [
        ...
        },
        {
            ...
            example: 'Mercury Design System provides a comprehensive set of design tokens and components.'
        },
        {
            variant: 'base',
            className: 'text-base',
            ...
            example: 'Our typography system is designed to provide clear hierarchy while maintaining excellent readability across all screen sizes.'
        },
        {
            variant: 'small',
            className: 'text-sm',
    ...
    return (
        <div className="space-y-8">
            <div className="space-y-4">
                ...
                <p className="text-slate-11">Our typography system uses Sohne as the primary font, with a carefully crafted scale for readability and hierarchy.</p>
            </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="space-y-2 border border-slate-6 rounded-lg p-4 bg-white">
                        ...
                        <div className="mt-4 space-y-2">
                            ...
                            <p className="font-normal text-slate-11">Secondary text in regular weight</p>
                            <p className="font-normal text-primary-11">Colored text in regular weight</p>
                        </div>
                    </div>
                    <div className="space-y-2 border border-slate-6 rounded-lg p-4 bg-white">
                        <p className="font-bold text-xl">Sohne Kraftig (700)</p>
                        <p className="text-slate-11">Bold weight for headings and emphasis</p>
                        <div className="mt-4 space-y-2">
            ...
            <div className="space-y-4">
                ...
                <div className="prose prose-slate max-w-none space-y-4">
                    <ul className="list-disc list-inside space-y-2 text-slate-11">
                        <li>Maintain consistent spacing between text elements using our spacing scale</li>
                        <li>Use appropriate line heights for optimal readability (already configured in Tailwind)</li>
                        <li>Ensure sufficient color contrast for accessibility (WCAG 2.1 AA standard)</li>
                        <li>Limit line length to 60-80 characters for optimal readability</li>
                        <li>Use semantic HTML elements (h1, h2, etc.) for proper document structure</li>
                    </ul>
                </div>
            </div>

            <div className="space-y-4">
                <h2 className="text-2xl font-bold text-slate-12">Real-world Examples</h2>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="border border-slate-6 rounded-lg p-6 bg-white space-y-4">
                        ...
                        <h4 className="text-xl font-bold text-slate-12">Getting Started with Mercury</h4>
                        <p className="text-lg text-slate-11">A comprehensive guide to our design system.</p>
                        <p className="text-base">Mercury Design System provides a robust set of design tokens, components, and patterns that help teams build consistent, accessible interfaces.</p>
                        <p className="text-sm text-slate-11">Published on January 15, 2024</p>
                    </div>
                    <div className="border border-slate-6 rounded-lg p-6 bg-white space-y-4">
                        ...
                        <div className="p-4 border border-slate-6 rounded-lg">
                            ...
                            <p className="text-base mt-2">Build beautiful, accessible interfaces with our comprehensive component library.</p>
