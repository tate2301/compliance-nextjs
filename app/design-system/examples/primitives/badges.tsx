    ...
    return (
        <div className="space-y-8">
            <div className="space-y-4">
                <h2 className="text-2xl font-bold tracking-tight text-slate-12">Badge Examples</h2>
                <p className="text-slate-11">Examples of badge components following our Mercury design system guidelines.</p>
            </div>
            ...
            <div className="grid grid-cols-1 gap-6">
                ...
                <ExampleCard title="Basic Badges">
                    <div className="flex flex-wrap gap-4">
                        ...
                        <Badge className="bg-green-9 hover:bg-green-10 text-slate-1">Success</Badge>
                        <Badge className="bg-amber-9 hover:bg-amber-10 text-slate-1">Warning</Badge>
                        <Badge className="bg-red-9 hover:bg-red-10">Error</Badge>
                    </div>
                    <div className="mt-4 text-sm text-slate-11 font-mono">Badge variants using Radix colors</div>
                </ExampleCard>

                {/* Badges with Icons */}
                <ExampleCard title="Badges with Icons">
                    <div className="flex flex-wrap gap-4">
                        <Badge className="gap-1 bg-green-9 hover:bg-green-10 text-slate-1">
                    ...
                    <div className="mt-4 text-sm text-slate-11 font-mono">Badges with icon+text combinations</div>
                </ExampleCard>

                {/* Status Badges */}
                <ExampleCard title="Status Badges">
                    <div className="flex flex-wrap gap-4">
                        <Badge className="gap-1.5 pl-1.5 bg-green-9 hover:bg-green-10 text-slate-1">
                            <Circle className="h-2 w-2 fill-green-5" /> Active
                        </Badge>
                        <Badge className="gap-1.5 pl-1.5 bg-amber-9 hover:bg-amber-10 text-slate-1">
                        ...
                        <Badge variant="outline" className="gap-1.5 pl-1.5">
                            <Circle className="h-2 w-2 fill-slate-5" /> Unknown
                        </Badge>
                    </div>
                    <div className="mt-4 text-sm text-slate-11 font-mono">Status indicators with subtle dot indicators</div>
                </ExampleCard>
                ...
                <ExampleCard title="Removable Badges">
                    <div className="flex flex-wrap gap-4">
                        <Badge className="gap-1 pr-1">
                            Default
                            <button className="rounded-full hover:bg-slate-5 p-0.5 transition-all duration-300">
                                <X className="h-3 w-3" />
                            </button>
                        </Badge>
                        <Badge variant="secondary" className="gap-1 pr-1">
                            Secondary
                            <button className="rounded-full hover:bg-slate-7 p-0.5 transition-all duration-300">
                                <X className="h-3 w-3" />
                            </button>
                        </Badge>
                        <Badge variant="outline" className="gap-1 pr-1">
                            Outline
                            <button className="rounded-full hover:bg-slate-3 p-0.5 transition-all duration-300">
                                <X className="h-3 w-3" />
                            </button>
                        </Badge>
                    </div>
                    <div className="mt-4 text-sm text-slate-11 font-mono">Removable badges with smooth hover transitions</div>
                </ExampleCard>
                ...
                <ExampleCard title="Semantic Badges">
                    <div className="space-y-4">
                        <div className="flex flex-wrap gap-4">
                            <Badge className="bg-green-9 hover:bg-green-10 text-slate-1 transition-all duration-300">Completed</Badge>
                            <Badge className="bg-amber-9 hover:bg-amber-10 text-slate-1 transition-all duration-300">In Progress</Badge>
                    ...
                    <div className="mt-4 text-sm text-slate-11 font-mono">Context-appropriate semantic state indicators</div>
                </ExampleCard>
                ...
                <ExampleCard title="Large Badges">
                    ...
                    <div className="mt-4 text-sm text-slate-11 font-mono">Larger badge variants for emphasis</div>
                </ExampleCard>
            </div>
        </div>
    )
