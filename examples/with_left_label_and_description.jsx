  ...
  return (
    <Switch.Group as="div" className="flex items-center justify-between">
      <span className="flex-grow flex flex-col">
        <Switch.Label as="span" className="text-sm font-medium text-slate-12" passive>
          Available to hire
        </Switch.Label>
        <Switch.Description as="span" className="text-sm text-slate-11">
      ...
      <Switch
        ...
        className={classNames(
          enabled ? 'bg-primary-9' : 'bg-slate-6',
