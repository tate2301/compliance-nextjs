...
export default function Example() {
  return (
    <div className="bg-sand-1 p-6 rounded-lg">
      <div>
        <h3 className="text-lg leading-6 font-medium text-sand-12">Applicant Information</h3>
        <p className="mt-1 max-w-2xl text-sm text-sand-11">Personal details and application.</p>
      </div>
      <div className="mt-5 border-t border-sand-6">
        <dl className="divide-y divide-sand-6">
          <div className="py-4 sm:py-5 sm:grid sm:grid-cols-3 sm:gap-4">
            <dt className="text-sm font-medium text-sand-11">Full name</dt>
          ...
          <div className="py-4 sm:grid sm:py-5 sm:grid-cols-3 sm:gap-4">
            ...
            <dd className="mt-1 text-sm text-sand-12 sm:mt-0 sm:col-span-2">
              <ul role="list" className="border border-sand-6 rounded-md divide-y divide-sand-6">
                <li className="pl-3 pr-4 py-3 flex items-center justify-between text-sm">
                  <div className="w-0 flex-1 flex items-center">
                    <PaperClipIcon className="flex-shrink-0 h-5 w-5 text-sand-11" aria-hidden="true" />
                  ...
                  <div className="ml-4 flex-shrink-0 flex space-x-4">
                    ...
                    <span className="text-sand-8" aria-hidden="true">
                      |
                    </span>
                    <Button
                      variant="ghost"
