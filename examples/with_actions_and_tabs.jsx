...
export default function Example() {
  return (
    <div className="relative pb-5 border-b border-sand-6 sm:pb-0">
      <div className="md:flex md:items-center md:justify-between">
        <h3 className="text-lg leading-6 font-medium text-sand-12">Candidates</h3>
      ...
      <div className="mt-4">
        <div className="sm:hidden">
          ...
          <select
            id="current-tab"
            name="current-tab"
            className="block w-full pl-3 pr-10 py-2 text-sm border-sand-6 bg-sand-2 text-sand-12 focus:outline-none focus:ring-primary-7 focus:border-primary-7 rounded-md transition-colors"
