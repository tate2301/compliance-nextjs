		...
		<div className="h-full divide-y divide-zinc-200">
			...
			<section className="space-y-6 p-6">
				<div>
					...
					<p className="text-xs text-zinc-400">Configure your form's basic information</p>
				</div>

				<div className="space-y-4">
					<div className="space-y-2">
						<Label htmlFor="formTitle" className="text-zinc-500">Form Title</Label>
						<Input
							id="formTitle"
							value={formTitle}
					...
					<div className="space-y-2">
						<Label htmlFor="formDescription" className="text-zinc-500">Description</Label>
						<Textarea
							id="formDescription"
					...
					<div className="space-y-2">
						<Label htmlFor="fontFamily" className="text-zinc-500">Font Family</Label>
						<Input
							id="fontFamily"
							value={fontFamily}
			...
			<section className="space-y-6 p-6">
				<div>
					...
					<p className="text-xs text-zinc-400">Customize the look and feel of your form</p>
				</div>
				...
				<div className="space-y-6">
								...
								>
									<div className="space-y-2">
										<div className="flex items-center justify-between">
											<h3 className="text-sm font-medium text-zinc-700">{presetTheme.name}</h3>
											{theme.id === presetTheme.id && (
					...
					<div className="space-y-4">
						...
						<div className="space-y-4 rounded-lg border bg-white p-4">
							<div className="space-y-2">
								<Label htmlFor="primaryColor" className="text-zinc-500">Primary Color</Label>
							...
							<div className="space-y-2">
								<Label htmlFor="backgroundColor" className="text-zinc-500">Background Color</Label>
								<div className="flex gap-3">
									<div
										className="h-10 w-10 rounded-lg ring-1 ring-inset ring-zinc-200"
